...
,sum(A06_PRODUCT_KPI_ACTIVITY.ORD_RATE)*100 as ORD_RATE
...
,sum(A06_PRODUCT_KPI_ACTIVITY.SUCCESS_ORD_RATE)*100 as SUCCESS_ORD_RATE
...
where A06_PRODUCT_KPI_ACTIVITY.PROMOTION_TYPE=1 
